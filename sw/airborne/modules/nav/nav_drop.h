...
extern uint8_t nav_drop_compute_approach(uint8_t wp_target, uint8_t wp_start, uint8_t wp_baseturn, uint8_t wp_climbout,
                                        float radius);
extern uint8_t nav_drop_update_release(uint8_t wp_target);
extern uint8_t nav_drop_shoot(void);
